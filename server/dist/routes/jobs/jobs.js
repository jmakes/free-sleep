...
const analyzeSleepLeft = () => {
    void executeAnalyzeSleep('left', moment().subtract(12, 'hours').toISOString(), moment().add(1, 'hours').toISOString());
};
const analyzeSleepRight = () => {
    void executeAnalyzeSleep('right', moment().subtract(12, 'hours').toISOString(), moment().add(1, 'hours').toISOString());
};

...
export function getCommandedTargetF(side) {
    return commandedTargetF[side];
}
export function setCommandedTargetF(side, tempF) {
    const clamped = clampTempF(tempF);
    commandedTargetF[side] = clamped;
    return clamped;
}
export function clearCommandedTargetF(side) {
    commandedTargetF[side] = undefined;
}
/**
 * Baseline for a temperature delta: prefer last command, else hardware target.
 */
export function resolveTargetBaselineF(side, hardwareTargetF, fallbackF) {
...
//# sourceMappingURL=commandedTemperature.js.map